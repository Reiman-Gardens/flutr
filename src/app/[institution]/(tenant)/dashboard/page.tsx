import { Bug, Building2, Newspaper, Package } from "lucide-react";
  ...
  return (
    <div className="mx-auto max-w-6xl px-6 py-10">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <NavCard
          href={ROUTES.tenant.butterflies(institution)}
          title="Butterflies"
          description="Customize species names and lifespans for your institution"
          icon={Bug}
        />
